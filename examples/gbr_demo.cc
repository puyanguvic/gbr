...
main(int argc, char* argv[])
{
    ...
    GBRHelper::PopulateRoutingTables();
    ...
    // // udp sender
    // Ptr<Socket> udpSocket = Socket::CreateSocket (nodes.Get (udpSender),
    // UdpSocketFactory::GetTypeId ()); Ptr<DGRUdpApplication> app = CreateObject<DGRUdpApplication>
    // (); app->Setup (udpSocket, InetSocketAddress (ipv4AddrUdpSink, udpPort), 150, 10, DataRate
