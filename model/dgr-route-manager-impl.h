...
class DGRRouteManagerLSDB
{
  ...
  private:
    typedef std::map<Ipv4Address, DGRRoutingLSA*>
        LSDBMap_t; //!< container of IPv4 addresses / Link State Advertisements
    typedef std::pair<Ipv4Address, DGRRoutingLSA*>
...
class DGRRouteManagerImpl
{
  ...
  private:
     ...
     */
    void SPFNext(DGRVertex* v, RouteCandidateQueue& candidate);
     ...
     */
    int SPFNexthopCalculation(DGRVertex* v,
                              DGRVertex* w,
                              DGRRoutingLinkRecord* l,
                              uint32_t distance);
     ...
     */
    DGRRoutingLinkRecord* SPFGetNextLink(DGRVertex* v,
                                         DGRVertex* w,
