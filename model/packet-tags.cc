...
{
    static TypeId tid =
        TypeId("BudgetTag").SetParent<Tag>().SetGroupName("dgr-rl").AddConstructor<BudgetTag>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("ns3::DistTag").SetParent<Tag>().SetGroupName("dgr-rl").AddConstructor<DistTag>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("FlagTag").SetParent<Tag>().SetGroupName("dgr-rl").AddConstructor<FlagTag>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("PriorityTag").SetParent<Tag>().SetGroupName("dgrv2").AddConstructor<PriorityTag>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("NSTag").SetParent<Tag>().SetGroupName("dgrv2").AddConstructor<NSTag>();
    return tid;
}
